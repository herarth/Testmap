...
map.getView().fit([8868124.054347, 716623.726749, 9221987.254489, 947493.431339], map.getSize());
    ...
    element: (() => {
        ...
        if (45 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'this web map shows the ROADS AND WATERR in SL';
            }
